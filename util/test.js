...
describe('User Controller', () => {
  ...
  it('should create a new user', async () => {
    const res = await request(app)
      .post('/api/users')
      .send({ userName: 'test14', age: 25, hobbies: ['reading', 'coding'] });
    ...
    expect(responce.data).toHaveProperty('id');

    createdUserId = responce.data.id; 
  ...
  it('should update an existing user', async () => {
    ...
    expect(responce).toHaveProperty('data');
    expect(responce.data).toHaveProperty('id', createdUserId);
